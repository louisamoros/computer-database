...
/**
 * Abstract builder class used to set validation workflow when building dto with builder pattern.
 * @param <T> the dto to check and build
 */
public abstract class AbstractBuilderDto<T> {

    private static Validator validator = Validation.buildDefaultValidatorFactory().getValidator();

    /**
     * Internal building class to be override by builder class dto.
