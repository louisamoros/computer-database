...
public final class QueryGenerator {
    ...
    public static class Builder {
         ...
         * Building the like.
         *
         * @param like the like attribute (working with where)
         * @return builder
         */
        public final Builder like(final String like) {
            query.append(LIKE).append("'%").append(like).append("%'");
            return this;
        }
         ...
         * Building the or.
         *
         * @param or the or attribute
         * @return builder
         */
        public final Builder or(final String or) {
