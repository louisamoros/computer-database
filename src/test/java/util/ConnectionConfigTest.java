...
public class ConnectionConfigTest {
	...
	public static void initConnection() throws Exception {
		...
		LOGGER.debug(properties.getProperty("username"));

		try {
			RunScript.execute(properties.getProperty("url"), properties.getProperty("username"),
	...
	private void cleanlyInsert(IDataSet dataSet) throws Exception {
		IDatabaseTester databaseTester = new JdbcDatabaseTester(properties.getProperty("driver"),
